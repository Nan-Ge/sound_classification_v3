...
class xvecTDNN(nn.Module):
    ...
    def __init__(self, inputDim, args, padding=0):
        ...
        self.tdnn1 = nn.Conv1d(in_channels=inputDim, out_channels=tdnnDim, kernel_size=5, dilation=1, padding=padding)
        self.bn_tdnn1 = nn.BatchNorm1d(tdnnDim, momentum=0.1, affine=False)
        self.dropout_tdnn1 = nn.Dropout(p=p_dropout)

        self.tdnn2 = nn.Conv1d(in_channels=tdnnDim, out_channels=tdnnDim, kernel_size=5, dilation=1, padding=padding)
        self.bn_tdnn2 = nn.BatchNorm1d(tdnnDim, momentum=0.1, affine=False)
        self.dropout_tdnn2 = nn.Dropout(p=p_dropout)

        self.tdnn3 = nn.Conv1d(in_channels=tdnnDim, out_channels=tdnnDim, kernel_size=7, dilation=1, padding=padding)
        self.bn_tdnn3 = nn.BatchNorm1d(tdnnDim, momentum=0.1, affine=False)
        self.dropout_tdnn3 = nn.Dropout(p=p_dropout)

        self.tdnn4 = nn.Conv1d(in_channels=tdnnDim, out_channels=tdnnDim, kernel_size=1, dilation=1, padding=padding)
        self.bn_tdnn4 = nn.BatchNorm1d(tdnnDim, momentum=0.1, affine=False)
        self.dropout_tdnn4 = nn.Dropout(p=p_dropout)

        self.tdnn5 = nn.Conv1d(in_channels=tdnnDim, out_channels=tdnnFinalDim, kernel_size=1, dilation=1, padding=padding)
